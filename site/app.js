(function () {
  ...
  var EMBED_STYLES = [
    ...
    "  body.command-center-embed :where(button, .button, .button-secondary, .preview-download, .open-presentation, .expand-control, .carousel-arrow, .showcase-expand, .showcase-arrow, .legend-item, .mode-toggle button, .reset-filters) { min-height: 2.75rem; }",
    ...
    "  body.command-center-roadmap :where(.showcase-section-title, .timeline-section-title) { font-size: clamp(3rem, 10vw, 5rem) !important; line-height: 0.96 !important; }",
    ...
    "  body.command-center-roadmap :where(.showcase-section-title, .timeline-section-title) { font-size: clamp(2.65rem, 13vw, 4rem) !important; }",
    "}",
